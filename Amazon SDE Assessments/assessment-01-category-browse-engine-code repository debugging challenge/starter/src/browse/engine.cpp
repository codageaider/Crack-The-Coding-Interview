...
Engine Engine::from_categories(const std::vector<Category>& categories) {
    ...
    // TODO: This creates category entries but does not connect parents to children.
...
std::vector<BrowseResult> Engine::evaluate(
    ...
    for (const Request& request : requests) {
        ...
        for (const Product& product : products) {
            // TODO: The category condition is inverted and region is not checked.
        ...
        // TODO: Both ranking directions are wrong.
