...
Product parse_product_jsonl_line(const std::string& line) {
    ...
    // TODO: These fields are currently mapped incorrectly.
    product.name = string_field(line, "product_id");
    product.product_id = string_field(line, "name");
    product.category_id = string_field(line, "category_id");
    product.region = string_field(line, "region");

    // TODO: The popularity score is currently ignored.
